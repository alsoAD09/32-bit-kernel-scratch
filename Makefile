...
# Create all necessary subdirectories automatically
$(shell mkdir -p ./bin ./build ./build/idt ./build/memory/heap ./build/memory/paging ./build/io ./build/disk ./build/fs ./build/string)
